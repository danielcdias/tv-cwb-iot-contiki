...
#define INTERRUPTION_SENSOR_WAIT_INTERVAL_TO_RESET_ON_TEST 40 // seconds
...
#define MIN_INTERVAL_REPORT_WATER_ON_DRAIN 300 // seconds
#define MIN_INTERVAL_REPORT_WATER_ON_DRAIN_ON_TEST 30 // seconds
